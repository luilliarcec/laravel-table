...
class SelectMultipleTest extends TestCase
{
    ...
    public function render_with_tailwind_theme()
    {
        ...
        $view
            ...
            ->assertRender('
                <select class="border-gray-300 focus:ring-1 focus:ring-blue-900 focus:border-blue-700 block w-full pr-10 text-sm rounded-md filter-select-multiple" name="filter[languages][]" multiple >
